...
public class CellDamageIterator : MonoBehaviour
{
    public bool m_isTrigger = false;
    public GridMapController m_GripMapController;
    public int m_DamagePackNUM = 1;
    ...
    {
        m_isTrigger = true;
        GetComponent<GridOBJ>().m_Witcher.GetComponent<WitcherWeapon>().AddDamage(m_DamagePackNUM);
